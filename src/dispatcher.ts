...
import type { BrainCommand, CommandResponse, BcMeta } from "./shared/types/command";
import { logger } from "./shared/utils/logger";

// ドメイン別ディスパッチャー
import { noteDispatcher } from "./modules/note";
import { searchDispatcher } from "./modules/search";
import { clusterDispatcher } from "./modules/cluster";
import { driftDispatcher } from "./modules/drift";
import { ptmDispatcher } from "./modules/ptm";
import { influenceDispatcher } from "./modules/influence";
import { clusterDynamicsDispatcher } from "./modules/cluster";
import { insightDispatcher } from "./modules/insight";
import { analyticsDispatcher } from "./modules/analytics";
import { gptDispatcher } from "./modules/gpt";
import { systemDispatcher } from "./modules/system";
import { jobDispatcher, workflowDispatcher } from "./modules/jobs";
import { ragDispatcher } from "./modules/gpt";
import { decisionDispatcher } from "./modules/decision";
import { promotionDispatcher } from "./modules/promotion";
import { reviewDispatcher } from "./modules/review";
import { bookmarkDispatcher } from "./modules/bookmark";
import { isolationDispatcher } from "./modules/isolation";
import { llmInferenceDispatcher } from "./modules/inference";
import { conditionDispatcher } from "./modules/condition";
...
register("condition", conditionDispatcher);
