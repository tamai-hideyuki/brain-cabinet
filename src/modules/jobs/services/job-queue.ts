...
import { buildSearchIndex } from "../../search/embeddingService";
import {
  createJob,
  startJob,
  completeJob,
...
import type { JobType as SchemaJobType } from "../../../shared/db/schema";
...
export type ClusterRebuildPayload = {
  ...
  forceRegenerate?: boolean; // 全ノートの Embedding を強制再生成（デフォルト: false）
